...
public :
   ...
   TH1F *h_nVtx_num[10][9], *h_nVtx_num_QCD[10][9];
   TH1F *h_phoPt_num[10][9], *h_phoPt_num_QCD[10][9];
   TH1F *h_pfMET_num[10][9], *h_pfMET_num_QCD[10][9];
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void fillHistosNum(int sysNumber, int index,double event_weight);
   virtual void fillHistosNum_QCD(int sysNumber, int index,double event_weight);
   ...
   Double_t EAcharged(Double_t eta);  //mod2
   Double_t EAneutral(Double_t eta);
   Double_t EAphoton(Double_t eta);
   Double_t EAchargedworst(Double_t eta);
   Double_t EcalEA(Double_t eta);  //mod2
   Double_t HcalEA(Double_t eta);  //mod2
   Double_t EcalEA_ptscale(Double_t eta, Double_t pt);  //mod2
   ...
   double sieie_correction(Float_t sieie, int shift);
};
...
{
  //TChain *chain = new TChain("fullEB/fullEBTree");
