...
void plot_sideband_purity(int i, float full_lumi){
  ...
  TFile *GJets_40to100 = new TFile("GJets_40To100.root");
  TFile *GJets_100to200 = new TFile("GJets_DR100To200.root");
  TFile *GJets_200to400 = new TFile("GJets_DR200To400.root");
  TFile *GJets_400to600 = new TFile("GJets_DR400To600.root");
  TFile *GJets_600toInf = new TFile("GJets_DR600ToInf.root");
  TFile *f_data = new TFile("Alldata_QCDfake.root");
  ...
  sieie_num_QCDsideband_GJets_40to100->Scale(18660.0*full_lumi*1000.0/1947013);
  sieie_num_QCDsideband_GJets_100to200->Scale(5028.0*full_lumi*1000.0/9939048.0);
  sieie_num_QCDsideband_GJets_200to400->Scale(1128.0*full_lumi*1000.0/33884844.0);
  sieie_num_QCDsideband_GJets_400to600->Scale(126.5*full_lumi*1000.0/9022800.0);
  sieie_num_QCDsideband_GJets_600toInf->Scale(41.24*full_lumi*1000.0/8330226.0);
  ...
  sieie_num_QCDsideband_data->GetYaxis()->SetTitle("Yield for 41.5 fb^{-1}");
  ...
  if (highPt == "225") upper_limit = 7000.0; // good
  ...
  TLatex *texS = new TLatex(0.61023,0.907173,"41.5 fb^{-1} (13 TeV)");
  texS->SetNDC();
  texS->SetTextFont(42);
...
std::vector<Float_t> run_template_fit(int i, int j, float full_lumi)
{
  ...
  sieie_num_GJets_40to100->Scale(18660.0*full_lumi*1000.0/2422735.0);
  sieie_num_GJets_100to200->Scale(5028.0*full_lumi*1000.0/9939048.0);
  sieie_num_GJets_200to400->Scale(1128.0*full_lumi*1000.0/33884844.0);
  sieie_num_GJets_400to600->Scale(126.5*full_lumi*1000.0/9022800.0);
  sieie_num_GJets_600toInf->Scale(41.24*full_lumi*1000.0/8330226.0);
  ...
  */
  ...
  sieie_num_QCDsideband_GJets_40to100->Scale(18660.0*full_lumi*1000.0/2422735.0);
  sieie_num_QCDsideband_GJets_100to200->Scale(5028.0*full_lumi*1000.0/9939048.0);
  sieie_num_QCDsideband_GJets_200to400->Scale(1128.0*full_lumi*1000.0/33884844.0);
  sieie_num_QCDsideband_GJets_400to600->Scale(126.5*full_lumi*1000.0/9022800.0);
  sieie_num_QCDsideband_GJets_600toInf->Scale(41.24*full_lumi*1000.0/8330226.0);
  ...
  */
  ...
  if (j == 7 || j == 8){
    ...
    sieie_num_GJets_40to100_central->Scale(18660.0*full_lumi*1000.0/2422735.0);
    sieie_num_GJets_100to200_central->Scale(5028.0*full_lumi*1000.0/9939048.0);
    sieie_num_GJets_200to400_central->Scale(1128.0*full_lumi*1000.0/33884844.0);
    sieie_num_GJets_400to600_central->Scale(126.5*full_lumi*1000.0/9022800.0);
    sieie_num_GJets_600toInf_central->Scale(41.24*full_lumi*1000.0/8330226.0);
    ...
    */
    ...
    if (j == 7){
      ...
      sieie_num_GJets_40to100_sieieUp->Scale(18660.0*full_lumi*1000.0/2422735.0);
      sieie_num_GJets_100to200_sieieUp->Scale(5028.0*full_lumi*1000.0/9939048.0);
      sieie_num_GJets_200to400_sieieUp->Scale(1128.0*full_lumi*1000.0/33884844.0);
      sieie_num_GJets_400to600_sieieUp->Scale(126.5*full_lumi*1000.0/9022800.0);
      sieie_num_GJets_600toInf_sieieUp->Scale(41.24*full_lumi*1000.0/8330226.0);
    ...
    if (j == 8){
      ...
      sieie_num_GJets_40to100_sieieDown->Scale(18660.0*full_lumi*1000.0/2422735.0);
      sieie_num_GJets_100to200_sieieDown->Scale(5028.0*full_lumi*1000.0/9939048.0);
      sieie_num_GJets_200to400_sieieDown->Scale(1128.0*full_lumi*1000.0/33884844.0);
      sieie_num_GJets_400to600_sieieDown->Scale(126.5*full_lumi*1000.0/9022800.0);
      sieie_num_GJets_600toInf_sieieDown->Scale(41.24*full_lumi*1000.0/8330226.0);
    ...
    sieie_num_QCDsideband_GJets_40to100_central->Scale(18660.0*full_lumi*1000.0/2422735.0);
    sieie_num_QCDsideband_GJets_100to200_central->Scale(5028.0*full_lumi*1000.0/9939048.0);
    sieie_num_QCDsideband_GJets_200to400_central->Scale(1128.0*full_lumi*1000.0/33884844.0);
    sieie_num_QCDsideband_GJets_400to600_central->Scale(126.5*full_lumi*1000.0/9022800.0);
    sieie_num_QCDsideband_GJets_600toInf_central->Scale(41.24*full_lumi*1000.0/8330226.0);
    ...
    if (j == 7){
      ...
      sieie_num_QCDsideband_GJets_40to100_sieieUp->Scale(18660.0*full_lumi*1000.0/2422735.0);
      sieie_num_QCDsideband_GJets_100to200_sieieUp->Scale(5028.0*full_lumi*1000.0/9939048.0);
      sieie_num_QCDsideband_GJets_200to400_sieieUp->Scale(1128.0*full_lumi*1000.0/33884844.0);
      sieie_num_QCDsideband_GJets_400to600_sieieUp->Scale(126.5*full_lumi*1000.0/9022800.0);
      sieie_num_QCDsideband_GJets_600toInf_sieieUp->Scale(41.24*full_lumi*1000.0/8330226.0);
    ...
    if (j == 8){
      ...
      sieie_num_QCDsideband_GJets_40to100_sieieDown->Scale(18660.0*full_lumi*1000.0/2422735.0);
      sieie_num_QCDsideband_GJets_100to200_sieieDown->Scale(5028.0*full_lumi*1000.0/9939048.0);
      sieie_num_QCDsideband_GJets_200to400_sieieDown->Scale(1128.0*full_lumi*1000.0/33884844.0);
      sieie_num_QCDsideband_GJets_400to600_sieieDown->Scale(126.5*full_lumi*1000.0/9022800.0);
      sieie_num_QCDsideband_GJets_600toInf_sieieDown->Scale(41.24*full_lumi*1000.0/8330226.0);
  ...
  sieie_num_QCDsideband_GJets_40to100->GetXaxis()->SetTitle("#sigma_{i#etai#eta}");
  sieie_num_QCDsideband_GJets_40to100->GetYaxis()->SetTitle("Yield for 41.5 fb^{-1}");
  sieie_num_QCDsideband_GJets_40to100->GetYaxis()->SetTitleOffset(1.8);
  sieie_num_QCDsideband_GJets_40to100->SetTitle("");
  sieie_num_QCDsideband_GJets_40to100->SetStats(0);
  sieie_num_QCDsideband_GJets_40to100->SetLineWidth(2);
  ...
  sieie.setRange("signal",0.0000,0.0103);
...
std::vector<Float_t> QCDfake_getSysbContents_phopt(int sysb, Float_t frac_175to200, Float_t frac_200to250, Float_t frac_250to300, Float_t frac_300to400, Float_t frac_400to1000, Float_t frac_error_175to200, Float_t frac_error_200to250, Float_t frac_error_250to300, Float_t frac_error_300to400, Float_t frac_error_400to1000)
{
  ...
  Float_t numUncorr_175to200 = sieie_175to200_num_data->Integral(1,sieie_175to200_num_data->FindBin(0.0103));
  Float_t numUncorr_200to250 = sieie_200to250_num_data->Integral(1,sieie_200to250_num_data->FindBin(0.0103));
  Float_t numUncorr_250to300 = sieie_250to300_num_data->Integral(1,sieie_250to300_num_data->FindBin(0.0103));
  Float_t numUncorr_300to400 = sieie_300to400_num_data->Integral(1,sieie_300to400_num_data->FindBin(0.0103));
  Float_t numUncorr_400to1000 = sieie_400to1000_num_data->Integral(1,sieie_400to1000_num_data->FindBin(0.0103));
...
void QCDfake_fakeratio_systematics_phopt()
{
  ...
  for(int i = 1; i <= 5; i++){
    for(int j = 0; j <= 8; j++){
      ...
      fraction_and_error = run_template_fit(i,j,41.5);
  ...
  Float_t PtBins[6] = {225., 250., 300., 400., 600., 1000. };
  ...
  fakeratio_vs_phoPt->GetXaxis()->SetRangeUser(225.0,1000.0);
  // fakeratio_vs_phoPt->GetYaxis()->SetRangeUser(0.0,0.055);
  //  fakeratio_vs_phoPt->GetYaxis()->SetRangeUser(0.0,1.0);
  fakeratio_vs_phoPt->GetYaxis()->SetRangeUser(0.0,0.3);
  ...
  c->SaveAs("QCDfake_fakeratio_phoPt_plot.C");
  ...
  TH1F *hs = c->DrawFrame(225.,0.8,1000.,1.4,"");
  ...
  texS = new TLatex(0.61023,0.907173,"41.5 fb^{-1} (13 TeV)");
  texS->SetNDC();
  texS->SetTextFont(42);
  texS->SetTextSize(0.045);
  texS->Draw("same");
  ...
  c->SaveAs("QCDfake_systematics_phoPt_plot.C");
